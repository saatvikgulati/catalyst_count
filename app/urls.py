...
urlpatterns = [
    path('user_list/', app_view.user_list, name='user_list'),
    path('accounts/signup/', app_view.add_user, name='account_signup'),
    path('accounts/logout/', app_view.Logout.as_view(), name='account_logout'),
    ...
    path('delete_user/<int:user_id>/', app_view.delete_user, name='delete_user'),
    path('accounts/login/', app_view.Login.as_view(), name='account_login'),
    path('upload_file/', app_view.upload_file, name='upload_file'),
    path('query_builder/', app_view.query_builder, name='query_builder'),

    # auto-complete urls
    path('autocomplete_name/',
         app_view.auto_complete_name,
         name='auto_complete_name'),
    path('autocomplete_domain/',
         app_view.auto_complete_domain,
         name='auto_complete_domain'),
    path('autocomplete_year_founded/',
         app_view.auto_complete_year_founded,
         name='auto_complete_year_founded'),
    path('autocomplete_industry/',
         app_view.auto_complete_industry,
         name='auto_complete_industry'),
    path('autocomplete_size_range/',
         app_view.auto_complete_size_range,
         name='auto_complete_size_range'),
    path('autocomplete_locality/',
         app_view.auto_complete_locality,
         name='auto_complete_locality'),
    path('autocomplete_country/',
         app_view.auto_complete_country,
         name='auto_complete_country'),
    path('autocomplete_linkedin_url/',
         app_view.auto_complete_linkedin_url,
         name='auto_complete_linkedin_url'),
    path('autocomplete_current_employee_estimate/',
         app_view.auto_complete_current_employee_estimate,
         name='auto_complete_current_employee_estimate'),
    path('autocomplete_total_employee_estimate/',
         app_view.auto_complete_total_employee_estimate,
         name='auto_complete_total_employee_estimate'),

    path('get_count/', app_view.CompanyApiView.as_view(), name='get_count'),
